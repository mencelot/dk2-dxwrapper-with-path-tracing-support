...
struct CONFIG
{
	...
	bool DdrawDisableLighting = false;			// Disable D3D lighting for RTX Remix compatibility
	bool DdrawConvertHomogeneousW = false;		// Convert D3DFVF_XYZRHW to D3DFVF_XYZW for RTX Remix
	bool DdrawConvertHomogeneousToWorld = false;	// Convert pre-transformed vertices to world space for RTX Remix
	bool DdrawConvertHomogeneousToWorldUseGameCamera = false;	// Use game's camera transform if available
	float DdrawConvertHomogeneousToWorldFOV = 90.0f;			// FOV for reconstructed camera
	float DdrawConvertHomogeneousToWorldNearPlane = 1.0f;		// Near plane for reconstructed camera
	float DdrawConvertHomogeneousToWorldFarPlane = 1000.0f;		// Far plane for reconstructed camera
	float DdrawConvertHomogeneousToWorldDepthOffset = 0.0f;		// Depth offset for vertex conversion
	bool DdrawLogTextureAtlas = false;			// Log texture atlas operations for RTX Remix analysis
